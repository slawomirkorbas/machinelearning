...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"com.ml.tictactoe"})
public class TictactoeConfiguration implements WebMvcConfigurer
{
    ...
    {
        return new TrainedModelFactory();
    }


    @Bean
    Engine engine(TrainedModelFactory trainedModelFactory)
    {
        return new Engine(trainedModelFactory.getModel());
    }
}
